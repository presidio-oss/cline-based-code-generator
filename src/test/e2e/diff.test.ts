...
e2e("Diff editor", async ({ page, sidebar }) => {
	...
	const helpBanner = sidebar.getByText("Help Improve HAI")
	...
	// HAI should respond with a file edit request
	await expect(sidebar.getByText("HAI wants to edit this file:")).toBeVisible()

...
export class VscodeWebviewProvider extends WebviewProvider implements vscode.WebviewViewProvider {
	...
	public static readonly SIDEBAR_ID = "hai.SidebarProvider"
	public static readonly TAB_PANEL_ID = "hai.TabPanelProvider"
	...
	/**
	 * Public method to send gRPC responses from the controller to the webview
	 * This allows the controller to send gRPC response messages that the webview can handle
	 *
	 * @param response - The gRPC response to send
	 * @returns A thenable that resolves to a boolean indicating success, or undefined if the webview is not available
	 */
	public async sendGrpcResponse(response: { message: any; request_id: string }): Promise<boolean | undefined> {

	...
	async validateAPIKey(): Promise<boolean> {
		try {
			...
			if (modelId.includes("claude")) {
				...
				// Use the geminiHandler's validateAPIKey method instead
				// which already has the proper implementation for Gemini models
				return await this.geminiHandler.validateAPIKey()
			}

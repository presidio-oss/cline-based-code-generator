...
/**
 * Performs intialization for HAI that is common to all platforms.
 *
 * @param context
...
export async function initialize(context: vscode.ExtensionContext): Promise<WebviewProvider> {
	...
	let distinctId = context.globalState.get<string>("hai.distinctId")
	if (!distinctId) {
		try {
...
/**
 * Performs cleanup when HAI is deactivated that is common to all platforms.
 */

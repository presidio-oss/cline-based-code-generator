        ...
        return [
            ...
            vscode.commands.registerCommand("hai.editSelectedWithAI", async () => {
                ...
                try {
                        ...
                        if (chunk.type === "text") {
                            ...
                            for (let i = 0; i < enhancedTextLines.length; i++) {
                                ...
                                const lineRange = new vscode.Range(
                                    ...
                                    new vscode.Position(selectionStart.line + i,
                                        vscode.window.activeTextEditor?.document.lineAt(selectionStart.line + i).range.end.character || line.length
                                    )
                                )
                                if (selectionStart.line + i >= selectionEnd.line && !linesInserted.includes(selectionStart.line + i)) {
                                    try {
                                        await editor.edit((editBuilder) => {
                                            editBuilder.insert(
                                                new vscode.Position(selectionStart.line + i, 0),
                    ...
                    editor.setDecorations(enhancedDecoration, [
                        enhancedRange
                    ])

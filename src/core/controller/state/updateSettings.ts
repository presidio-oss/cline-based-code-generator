...
import {
	...
	convertProtoHaiBuildContextOptionsToHaiBuildContextOptions,
...
export async function updateSettings(controller: Controller, request: UpdateSettingsRequest): Promise<Empty> {
	try {
		...
		if (request.embeddingConfiguration) {
			...
			controller.cacheService.setEmbeddingConfiguration(embeddingConfiguration)
		}
		...
		if (request.enableInlineEdit !== undefined) {
			controller.cacheService.setGlobalState("enableInlineEdit", request.enableInlineEdit)
		}
		...
		if (request.buildContextOptions !== undefined) {
			...
			const buildContextOptions = convertProtoHaiBuildContextOptionsToHaiBuildContextOptions(request.buildContextOptions)
			controller.cacheService.setWorkspaceState("buildContextOptions", buildContextOptions)
		}

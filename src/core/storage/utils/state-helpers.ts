...
export async function readStateFromDisk(context: ExtensionContext) {
	...
	// Embedding configuration global state values
	const embeddingProvider = context.globalState.get("embeddingProvider") as string | undefined
	const embeddingModelId = context.globalState.get("embeddingModelId") as string | undefined
	const embeddingAwsRegion = context.globalState.get("embeddingAwsRegion") as string | undefined
	const embeddingOpenAiBaseUrl = context.globalState.get("embeddingOpenAiBaseUrl") as string | undefined
	const embeddingOpenAiModelId = context.globalState.get("embeddingOpenAiModelId") as string | undefined
	const embeddingAzureOpenAIApiInstanceName = context.globalState.get("embeddingAzureOpenAIApiInstanceName") as
		| string
		| undefined
	const embeddingAzureOpenAIApiEmbeddingsDeploymentName = context.globalState.get(
		"embeddingAzureOpenAIApiEmbeddingsDeploymentName",
	) as string | undefined
	const embeddingAzureOpenAIApiVersion = context.globalState.get("embeddingAzureOpenAIApiVersion") as string | undefined
	const embeddingOllamaBaseUrl = context.globalState.get("embeddingOllamaBaseUrl") as string | undefined
	const embeddingOllamaModelId = context.globalState.get("embeddingOllamaModelId") as string | undefined
	const embeddingMaxRetries = context.globalState.get("embeddingMaxRetries") as number | undefined

	// TAG:HAI - Get HAI-specific global state values
	const enableInlineEdit = context.globalState.get("enableInlineEdit") as boolean | undefined
	const expertPrompt = context.globalState.get("expertPrompt") as string | undefined
	const expertName = context.globalState.get("expertName") as string | undefined
	const isDeepCrawlEnabled = context.globalState.get("isDeepCrawlEnabled") as boolean | undefined
	...
	const [
		...
		context.secrets.get("embeddingApiKey") as Promise<string | undefined>,
		context.secrets.get("embeddingOpenRouterApiKey") as Promise<string | undefined>,
		context.secrets.get("embeddingAwsAccessKey") as Promise<string | undefined>,
		context.secrets.get("embeddingAwsSecretKey") as Promise<string | undefined>,
		context.secrets.get("embeddingAwsSessionToken") as Promise<string | undefined>,
		context.secrets.get("embeddingOpenAiApiKey") as Promise<string | undefined>,
		context.secrets.get("embeddingOpenAiNativeApiKey") as Promise<string | undefined>,
		context.secrets.get("embeddingAzureOpenAIApiKey") as Promise<string | undefined>,
	])
	...
	return {
		...
		// TAG:HAI - HAI-specific configuration
		haiConfiguration: {
			enableInlineEdit,
			buildContextOptions,
			buildIndexProgress,

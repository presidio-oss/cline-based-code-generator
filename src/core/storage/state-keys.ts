...
export interface GlobalState {
	...
	isDeepCrawlEnabled: boolean | undefined
	enableInlineEdit: boolean | undefined

	// Embedding configuration
	embeddingProvider: string | undefined
	embeddingModelId: string | undefined
	embeddingAwsRegion: string | undefined
	embeddingOpenAiBaseUrl: string | undefined
	embeddingOpenAiModelId: string | undefined
	embeddingAzureOpenAIApiInstanceName: string | undefined
	embeddingAzureOpenAIApiEmbeddingsDeploymentName: string | undefined
	embeddingAzureOpenAIApiVersion: string | undefined
	embeddingOllamaBaseUrl: string | undefined
	embeddingOllamaModelId: string | undefined
...
export interface Secrets {
	...
	embeddingOpenRouterApiKey: string | undefined
	embeddingAwsAccessKey: string | undefined
	embeddingAwsSecretKey: string | undefined
	embeddingAwsSessionToken: string | undefined
	embeddingOpenAiApiKey: string | undefined
	embeddingOpenAiNativeApiKey: string | undefined
	embeddingAzureOpenAIApiKey: string | undefined
}

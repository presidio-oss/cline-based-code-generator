...
const ACTION_METADATA: ActionMetadata[] = [
	{
		...
		shortName: "Read",
		description: "Allows HAI to read files within your workspace.",
		icon: "codicon-search",
		subAction: {
			id: "readFilesExternally",
			label: "Read all files",
			shortName: "Read (all)",
			description: "Allows HAI to read any file on your computer.",
	...
	},
	{
		...
		shortName: "Edit",
		description: "Allows HAI to modify files within your workspace.",
		icon: "codicon-edit",
		subAction: {
			id: "editFilesExternally",
			label: "Edit all files",
			shortName: "Edit (all)",
			description: "Allows HAI to modify any file on your computer.",
			icon: "codicon-files",
	...
	},
	{
		...
		description:
			"Allows HAI to execute safe terminal commands. If the model determines a command is potentially destructive, it will still require approval.",
		icon: "codicon-terminal",
		subAction: {
			id: "executeAllCommands",
			label: "Execute all commands",
			shortName: "All Commands",
			description: "Allows HAI to execute all terminal commands. Use at your own risk.",
	...
	},
	{
		...
		shortName: "Browser",
		description: "Allows HAI to launch and interact with any website in a browser.",
		icon: "codicon-globe",
	},
	{
		id: "useMcp",
		...
		shortName: "MCP",
		description: "Allows HAI to use configured MCP servers which may modify filesystem or interact with APIs.",
		icon: "codicon-server",
	},
	{
		id: "enableAll",
	...
	},
	{
		...
		description: "Receive system notifications when HAI requires approval to proceed or when a task is completed.",
		icon: "codicon-bell",
	},
]
					...
					{favorites.length > 0 ? (
						...
						<div
							...
							<div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
								<HeroTooltip
									content="Auto-approve allows HAI to perform the following actions without asking for permission. Please use with caution and only enable if you understand the risks."
									placement="top">
			...
			<div
				...
				{isExpanded && ( // Re-added conditional rendering for content
					<>
						...
						/>
						<HeroTooltip
							content="HAI will automatically make this many API requests before asking for approval to proceed with the task."
							placement="top">
							<div
								style={{
									display: "flex",

		...
		<div style={containerStyle}>
			...
			<ul style={ulStyle}>
				<li>
					...
					Available in the HAI provider for free.
				</li>
				<li>
					<b>Focus Chain:</b> Keeps HAI focused on long-horizon tasks with automatic todo list management, breaking down
					complex tasks into manageable steps with real-time progress tracking and passive reminders.
				</li>
				<li>
					<b>Auto Compact:</b> Auto summarizes your task and next steps when your conversation approaches the model's
					context window limit. This significantly helps HAI stay on track for long task sessions!
				</li>
				<li>
					<b>Deep Planning:</b> New <code>/deep-planning</code> slash command transforms HAI into an architect who
			...
			<Accordion className="pl-0" isCompact>
				<AccordionItem
					...
					<ul style={ulStyle}>
						<li>
							<b>Optimized for Claude 4:</b> HAI is now optimized to work with the Claude 4 family of models,

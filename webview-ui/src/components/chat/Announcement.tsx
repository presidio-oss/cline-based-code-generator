		...
		<div
			...
			<ul style={{ margin: "0 0 8px", paddingLeft: "12px" }}>
				<li>
					...
					auto-approved API requests, and enable system notifications for when HAI completes a task.
				</li>
				<li>
					<b>New diff editing for large files:</b> HAI now uses an efficient search & replace approach when
			...
			<ul style={{ margin: "0 0 8px", paddingLeft: "12px" }}>
				...
				<li>
					HAI can also create custom tools–just say "add a tool that...", and watch him create the MCP
					server and install it in the extension, ready to use in future tasks.
				</li>
				<li>
					Try it yourself by asking HAI to "add a tool that gets the latest npm docs", or

			...
			<Accordion isCompact className="pl-0">
				<AccordionItem
					...
					<ul style={ulStyle}>
						...
						<li>
							<b>WebFetch Tool:</b> Gemini 2.5 Pro and Claude 4 models now support the WebFetch tool, allowing HAI
							to retrieve and summarize web content directly in conversations.
						</li>
						<li>
							<b>Self Knowledge:</b> When using frontier models, HAI is self-aware about his capabilities and
							featureset.
						</li>
						<li>

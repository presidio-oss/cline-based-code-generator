			...
			case "command":
				return [
					...
					<span style={{ color: normalColor, fontWeight: "bold" }}>
						{message.type === "ask" ? "HAI wants to execute this command:" : "HAI executed this command:"}
					</span>,
				]
			case "use_mcp_server":
				...
				return [
					...
					<span style={{ color: normalColor, fontWeight: "bold" }}>
						{message.type === "ask" ? (
							...
							<>
								HAI {mcpServerUse.type === "use_mcp_tool" ? "used a tool" : "accessed a resource"} on the{" "}
								<code>{mcpServerUse.serverName}</code> MCP server:
							</>
						)}
					</span>,
					...
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? "HAI wants to edit this file:" : "HAI is editing this file:"}
							</span>
						</div>
						<CodeAccordian
				...
				return (
					<>
						<div style={headerStyle}>
							{toolIcon("new-file")}
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? "HAI wants to create a new file:" : "HAI is creating a new file:"}
							</span>
						</div>
						<CodeAccordian
							isLoading={message.partial}
				...
				return (
					<>
						<div style={headerStyle}>
							{toolIcon("file-code")}
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? "HAI wants to read this file:" : "HAI read this file:"}
							</span>
						</div>
						{/* <CodeAccordian
							code={tool.content!}
					...
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? (
									<>
										HAI wants to search this directory for <code>{tool.regex}</code>:
									</>
								) : (
									<>
										HAI searched this directory for <code>{tool.regex}</code>:
									</>
								)}
							</span>
						</div>
									...
									<p
										...
										{apiRequestFailedMessage?.toLowerCase().includes("powershell") && (
											<>
												...
												<a
													href="https://github.com/presidio-oss/cline-based-code-generator/wiki/TroubleShooting-%E2%80%90-%22PowerShell-is-not-recognized-as-an-internal-or-external-command%22"
													style={{
														color: "inherit",
					...
					return (
						<>
							<div
								...
								<div>
									HAI won't be able to view the command's output. Please update VSCode (

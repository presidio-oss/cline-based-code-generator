...
import ChatRowExtra from "./ChatRowExtra"
			...
			case "command":
				return [
					...
					<span style={{ color: normalColor, fontWeight: "bold" }}>
						{message.type === "ask"
							? "HAI wants to execute this command:"
							: "HAI executed this command:"}
					</span>,
				]
			case "use_mcp_server":
				...
				return [
					...
					<span style={{ color: normalColor, fontWeight: "bold" }}>
						{message.type === "ask" ? (
							...
							<>
								HAI {mcpServerUse.type === "use_mcp_tool" ? "used a tool" : "accessed a resource"} on
					...
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? "HAI wants to edit this file:" : "HAI edited this file:"}
							</span>
						</div>
						<CodeAccordian
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "HAI wants to create a new file:"
									: "HAI created a new file:"}
							</span>
						</div>
						<CodeAccordian
							isLoading={message.partial}

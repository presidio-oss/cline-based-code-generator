...
import { useEvent, useInterval, useDebounce, useDeepCompareEffect } from "react-use"
...
const ApiOptions = ({
	...
	const { apiConfiguration, setApiConfiguration, uriScheme, openRouterModels } = extensionState
				...
				<div>
					<VSCodeTextField
						...
						<span style={{ fontWeight: 500 }}>
							AskSage API Key <span style={{ color: "var(--vscode-errorForeground)" }}>*</span>
						</span>
					</VSCodeTextField>
					<p
						style={{
					...
					<VSCodeTextField
						...
						<span style={{ fontWeight: 500 }}>
							AskSage API URL <span style={{ color: "var(--vscode-errorForeground)" }}>*</span>
						</span>
					</VSCodeTextField>
				</div>
			)}
			...
			{selectedProvider === "qwen" && (
				<div>
					...
					<VSCodeTextField
						...
						placeholder="Enter API Key...">
						<span style={{ fontWeight: 500 }}>
							Qwen API Key <span style={{ color: "var(--vscode-errorForeground)" }}>*</span>
						</span>
					</VSCodeTextField>
					<p
						style={{
			...
			{selectedProvider === "nebius" && (
				<div>
					<VSCodeTextField
						...
						placeholder="Enter API Key...">
						<span style={{ fontWeight: 500 }}>
							Nebius API Key <span style={{ color: "var(--vscode-errorForeground)" }}>*</span>
						</span>
					</VSCodeTextField>
					<p
						style={{
			...
			{selectedProvider === "xai" && (
				<div>
					<VSCodeTextField
						...
						placeholder="Enter API Key...">
						<span style={{ fontWeight: 500 }}>
							X AI API Key <span style={{ color: "var(--vscode-errorForeground)" }}>*</span>
						</span>
					</VSCodeTextField>
					<p
						style={{
			...
			{selectedProvider === "sambanova" && (
				<div>
					<VSCodeTextField
						...
						placeholder="Enter API Key...">
						<span style={{ fontWeight: 500 }}>
							SambaNova API Key <span style={{ color: "var(--vscode-errorForeground)" }}>*</span>
						</span>
					</VSCodeTextField>
					<p
						style={{

...
import {
	bedrockEmbeddingDefaultModelId,
...
export interface NormalizedEmbeddingConfig {
	...
	selectedModelId: string
	selectedModelInfo: EmbeddingModelInfo | undefined
}

export function normalizeEmbeddingConfiguration(embeddingConfiguration?: EmbeddingConfiguration): NormalizedEmbeddingConfig {
	...
	switch (provider) {
		...
		case "bedrock":
			return getProviderData(bedrockEmbeddingModels, bedrockEmbeddingDefaultModelId)
		case "openai-native":

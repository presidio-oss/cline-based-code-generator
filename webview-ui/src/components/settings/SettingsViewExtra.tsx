        ...
        <>
            <div
                ...
                <div style={{ width: "100%", backgroundColor: "#e5e7eb", height: "8px", borderRadius: "2px" }}>
                    <div style={{ backgroundColor: "#186DF0", height: "8px", width: `${buildIndexProgress?.progress ?? 0}%`, borderRadius: "2px" }}></div>
                </div>
                <span
                    style={{
                        paddingLeft: "4px"
        ...
        <>
            ...
            <div style={{ marginBottom: 5 }}>
                <VSCodeTextArea
                    ...
                    disabled={!buildContextOptions?.useIndex}
                    placeholder={
                        'e.g. "This is an e-commerce application", "This is an CRM application"'
                    }
                    onInput={(e: any) => {
                        setBuildContextOptions({
                            ...buildContextOptions!,
            ...
            <div style={{ marginBottom: 5 }}>
                <VSCodeTextArea
                    ...
                    disabled={!buildContextOptions?.useIndex}
                    placeholder={
                        'Comma separated list of folders to exclude from indexing'
                    }
                    onInput={(e: any) => {
                        setBuildContextOptions({
                            ...buildContextOptions!,
                ...
                <p
                    ...
                    List of folders to exclude from the code indexing. The following folders are ignored by default <span style={{
                        color: "#E8912D",
                        opacity: "80%"
                    }}>{HaiBuildDefaults.defaultDirsToIgnore.join(', ')}</span>
                </p>
            </div>
        </>
    )

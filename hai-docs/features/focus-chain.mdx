...
Focus Chain is a task management enhancement feature in HAI that provides automatic todo list management with real-time progress tracking throughout your tasks. 
...
This enables HAI to work on long-horizon tasks, seamlessly managing the context sent to LLMs, and keeping HAI on track across many context window resets.

<Tip>
  Focus Chain works particularly well with HAI's [Deep Planning slash command](/features/slash-commands/deep-planning), providing seamless progress tracking for implementation tasks created through the [planning process](/features/plan-and-act).
</Tip>
...
HAI analyzes your task and automatically creates a comprehensive todo list with:
...
- Seamless integration back into HAI's workflow
...
<Steps>
  <Step title="Open HAI Settings">
      - Click the gear icon in the HAI sidebar
      - Navigate to the "Features" section
  </Step>
  <Step title="Enable Focus Chain">
      - Check "Enable Focus Chain"
      - Optionally adjust "Remind HAI Interval" (default: 6 messages)
  </Step>
  <Step title="Start a New Task">
      - Begin a new task
      - HAI will automatically start creating and managing todo lists
  </Step>
</Steps>
...
| Remind HAI Interval | 6 | 1-100 messages | How often HAI updates the todo list |
...
HAI: [Analyzes request and creates todo list]
```

#### 2. Todo List Created

HAI creates a comprehensive plan for the task, stored in a markdown file:
...
As HAI works, the task header shows real-time progress:
...
<Steps>
  ...
  <Step title="Save the file">
    HAI automatically detects and uses your updates
  </Step>
</Steps>
...
Focus Chain works seamlessly with HAI's [Plan/Act mode](/features/plan-and-act):
...
<AccordionGroup>
  <Accordion title="For Effective Todo Lists">
    ...
    2. **Review Generated Lists**
      - Check that HAI's breakdown aligns with your expectations
  ...
  <Accordion title="For Complex Projects">
    ...
    3. **Regular Reviews**
      ...
      - Communicate changes to HAI through edits
  </Accordion>
...
Still stuck? Use the [/reportbug](/features/slash-commands/report-bug) command in HAI to get help.
...
Focus Chain turns HAI into your personal project manager, keeping you on track and your tasks organized. Give it a try on your next project!

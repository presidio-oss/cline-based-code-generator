...
<Frame>
	<img src="https://storage.googleapis.com/cline_public_images/docs/assets/workflows.png" alt="Workflows tab in HAI" />
</Frame>
...
- Leverage HAI's [built-in tools](/exploring-hai-tools/hai-tools-guide) like `ask_followup_question`, `read_file`, `search_files`, and `new_task`

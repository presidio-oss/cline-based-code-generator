...
New models drop constantly, so this guide focuses on what's working well with HAI right now. We'll keep it updated as the landscape shifts.
...
HAI automatically handles context limits with [auto-compact](/features/auto-compact). When you approach your model's limit, HAI summarizes the conversation to keep working. You don't need to micromanage this.

...
💡 **Key Point**: HAI isn't passive - it actively seeks to understand your project. You can either let it explore or guide its focus, especially in [Plan](https://docs.cline.bot/features/plan-and-act) mode.
...
3. **Team Projects**
    - Share common context files (consider using [.hairules](https://docs.cline.bot/features/cline-rules) files in project roots)

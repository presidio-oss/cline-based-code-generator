---
title: "Cerebras"
description: "Learn how to configure and use Cerebras's ultra-fast inference with HAI. Experience up to 2,600 tokens per second with wafer-scale chip architecture and real-time reasoning models."
---
...
3.  **Create a Key:** Generate a new API key. Give it a descriptive name (e.g., "HAI").
4.  **Copy the Key:** Copy the API key immediately. Store it securely.

### Supported Models

HAI supports the following Cerebras models:
...
#### No IDE Lock-In
Works with any OpenAI-compatible tool—Cursor, Continue.dev, HAI, or any other editor that supports OpenAI endpoints.

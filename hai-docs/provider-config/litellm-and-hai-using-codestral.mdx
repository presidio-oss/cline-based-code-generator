---
title: "LiteLLM & HAI (using Codestral)"
description: "Learn how to set up and run LiteLLM with HAI using the Codestral model. This guide covers Docker setup, configuration, and integration with HAI."
---

### Using LiteLLM with HAI

This guide demonstrates how to run a demo for LiteLLM starting with the Codestral model for use with HAI.
...
2. **Setup HAI**
    ...
    Once the LiteLLM server is up and running you can set it up in HAI:

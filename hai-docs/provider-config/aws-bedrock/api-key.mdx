...
description: "Set up AWS Bedrock with HAI using Bedrock API Keys. Simplest setup for individual developers to access frontier models."
---
...
By following these steps, you can quickly integrate AWS Bedrock with the HAI VS Code extension to accelerate development:
...
3. **Configure HAI in VS Code:** Install and set up HAI with your AWS API Key and choose an appropriate model.

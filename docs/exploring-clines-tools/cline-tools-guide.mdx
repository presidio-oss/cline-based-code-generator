---
title: "HAI Tools Reference Guide"
---
...
For the most up-to-date implementation details, you can view the full source code in the [HAI repository](https://github.com/hai/hai/blob/main/src/core/HAI.ts).
...
-   [Join the Discord community](https://discord.gg/hai)

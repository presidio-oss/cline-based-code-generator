---
title: "LM Studio"
description: "A quick guide to setting up LM Studio for local AI model execution with HAI."
---

## 🤖 Setting Up LM Studio with HAI

Run AI models locally using LM Studio with HAI.
...
<Frame>
	<img
		...
		alt="Configuring HAI with LM Studio"
	/>
</Frame>

### ⚠️ Important Notes

-   Start LM Studio before using with HAI
...
1. If HAI can't connect to LM Studio:

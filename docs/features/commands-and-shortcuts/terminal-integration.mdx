...
<Frame>
	<img src="https://storage.googleapis.com/hai_public_images/docs/assets/terminal-integration.png" alt="Terminal Integration" />
</Frame>
...
-   **Combine with file mentions**: After sending terminal output to HAI, you can enhance your question by mentioning relevant files using the @ mentions feature.

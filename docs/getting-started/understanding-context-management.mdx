...
1. **Evergreen Project Context (i.e.** [**Memory Bank**](https://github.com/presidio-oss/cline-based-code-generator/blob/main/docs/prompting/hai-memory-bank.mdx)**)**
...
3. **Team Projects**
    - Share common context files (consider using [.hairules](https://github.com/presidio-oss/cline-based-code-generator/blob/main/docs/prompting/prompt-engineering-guide.mdx) files in project roots)

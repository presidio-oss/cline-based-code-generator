...
<Frame caption="VS Code marketplace with HAI extension ready to install">
	<img
		...
		alt="VS Code marketplace showing HAI extension"
	/>
</Frame>
...
3. Search for "HAI".
4. Select "HAI" by saoudrizwan and click **Install**.
5. Reload if prompted.

### 👤 Creating Your HAI Account

Now that you have HAI installed, let's get you set up with your account:

1. **Sign In to HAI:**
    - Click the **Sign In** button in the HAI extension.
...
3. **Available AI Models:**
    ...
    - And more — all through your HAI account.
4.  -
...
Join our Discord community and engage with our team and other HAI users directly.
